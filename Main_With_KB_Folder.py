...
# Define the base directory for knowledge base
...
def create_review_agent(review_name: str, criteria: str, guidelines: str) -> Agent:
    ...
    def reviewer_agent(state: State) -> Dict:
        ...
        if isinstance(relevant_knowledge, list) and relevant_knowledge:
            # Assuming the first result is the most relevant for simplicity in this example
...
load_agents_from_db(DATABASE_PATH) # Agents are loaded from here
